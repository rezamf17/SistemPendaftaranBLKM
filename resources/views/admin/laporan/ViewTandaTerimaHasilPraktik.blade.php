...
@section('title')
View Tanda Terima Hasil Praktik
@endsection
@section('breadcrumb')
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">View Tanda Terima Hasil Praktik</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">View Tanda Terima Hasil Praktik</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  @section('content')
  <div class="card">
    <div class="card-header">View Tanda Terima Hasil Praktik</div>
    <div class="card-body">
      <div class="form-group">
        <form action="{{ url('LaporanTandaTerimaHasilPraktik') }}" method="post" accept-charset="utf-8">
          @csrf
        ...
        <input type="text" name="peminatan" value="{{$peminatan}}" class="form-control" ><label>Bahan Praktik :</label>
        <input type="text" name="bahan_praktik" value="{{$bahan_praktik}}" class="form-control" >
      </div>
